    ...
    return (
        <div>
            ...
            <div id="floorPlan">
                ...
                <div className="thover available" id="table1" onclick="change()"><p id="t1txt">Table 1</p><img id="preview1" src={Table1Preview} alt="Table 1 Preview"/></div>
                <div className="thover available" id="table2" onclick="change()"><p id="t2txt">Table 2</p><img id="preview2" src={Table2Preview} alt="Table 2 Preview"/></div>
                <div className="thover available" id="table3" onclick="change()"><p id="t3txt">Table 3</p><img id="preview3" src={Table3Preview} alt="Table 3 Preview"/></div>
                <div className="thover reserved" id="table4" onclick="change()"><p id="t4txt">Table 4</p><img id="preview4" src={Table4Preview} alt="Table 4 Preview"/></div>
                <div className="thover reserved" id="table5" onclick="change()"><p id="t5txt">Table 5</p><img id="preview5" src={Table5Preview} alt="Table 5 Preview"/></div>
